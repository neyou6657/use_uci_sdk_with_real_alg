...
/* 可选日志开关：开启后会把上层使用到的 SDF/SDFU/SDFR 接口输出到 stderr 或指定日志文件。 */
void UCI_SDF_SetLogEnabled(int enabled);
int UCI_SDF_GetLogEnabled(void);
int UCI_SDF_SetLogFile(const char *path);
